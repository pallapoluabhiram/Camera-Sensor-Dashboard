...
Rectangle {
    ...
    property var bookmarks: [] // Array of bookmark objects {index: int, name: string, timestamp: string}
    ...
    ColumnLayout {
        ...
        // Header with toggle for advanced controls
        RowLayout {
        ...
        // Connection to handle loop functionality
        Connections {
